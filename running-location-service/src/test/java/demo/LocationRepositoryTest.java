...
public class LocationRepositoryTest {
    ...
    public void whenSaveLocation_expectOk() {
        ...
        assertThat(this.repository.findByUnitInfoRunningId("ross-runningId-1", new PageRequest(0, 1)).getContent().get(0).getRunningId()).isEqualTo("ross-runningId-1");

        assertEquals("ross-runningId-1", this.repository.findByUnitInfoRunningId("ross-runningId-1", new PageRequest(0, 1)).getContent().get(0).getRunningId());
